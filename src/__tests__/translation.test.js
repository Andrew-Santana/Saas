    ...
    describe('Demo Page Specific Tests', () => {
        ...
        test('should have consistent service structures', () => {
            ...
            languages.forEach(language => {
                ...
                const barbershopServices = t('barbershopPage.services.items', { returnObjects: true });
                const salonServices = t('beautySalonPage.services.items', { returnObjects: true });
                const vetServices = t('vetClinicPage.services.items', { returnObjects: true });
